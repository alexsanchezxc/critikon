...
echo '</li>';
echo '<li><a href="#comentarios" data-toggle="tab">Comentarios</a>';
echo '</li>';
echo '</ul>';
...
echo '<iframe width="560" height="315" src="https://www.youtube.com/embed/'.$trailer.'" frameborder="0" allowfullscreen></iframe>';
echo '</div>';
