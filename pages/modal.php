...
echo '<li class="actores active"><a href="#actores" data-toggle="tab">Actores</a>';
echo '</li>';
echo '<li class="trailer"><a href="#trailer" data-toggle="tab">Trailers</a>';
echo '</li>';
echo '<li class="comentarios"><a href="#comentarios" data-toggle="tab">Comentarios</a>';
echo '</li>';
echo '</ul>';
...
echo '</div>';
echo '</div>';
echo '<div class="tab-pane fade" id="comentarios">';
