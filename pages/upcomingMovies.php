  ...
  <div id="wrapper">
    ...
    <div id="page-wrapper">
      ...
      if (isset($_REQUEST['boton'])) {
        ...
        if (@$_GET['page'] > 0){
           $movies = $tmdb->getUpcomingMovies($_GET['page']);
        }
        // NOTE: Devuleve el array de Movie Object
        echo '<div class="row">';
        echo '<div class="col-lg-12">';
    ...
    <center>
      <ul class="pagination pagination-lg">
          <li id="page1" class="active"><a href="upcomingMovies.php?page=1">1</a></li>
          <li id="page2" ><a href="upcomingMovies.php?page=2">2</a></li>
          <li id="page3" ><a href="upcomingMovies.php?page=3">3</a></li>
          <li id="page4" ><a href="upcomingMovies.php?page=4">4</a></li>
          <li id="page5" ><a href="upcomingMovies.php?page=5">5</a></li>
      </ul>
    </center>
  </div>
  <!-- NOTE: #wrapper -->
